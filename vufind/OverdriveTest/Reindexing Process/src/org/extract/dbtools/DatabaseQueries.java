 ...
 * 
 * It is also designed to execute the preparedStatement. 
...
public class DatabaseQueries {
	 ...
	 * column names and corresponding value must be passed through HashMap<String, String> 
	 * @param tableName
	 * @param tableContents
	 ...
	 * delete condition must be passed in HashMap<String, String> format
	 * @param tableName
	 * @param condition
	 * 			HashMap with column names and column values
	 * @param operator
	 ...
	 * The updates must be passed through HashMap<String, String> as second argument and condition as third argument
	 ...
	 * select should in HashSet<String> format as second arg and condition in HashMap<String, String> as third args
	 * @param tableName
	 * @param columns
