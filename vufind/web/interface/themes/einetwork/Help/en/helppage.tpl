...
<dl class="Content">
  ...
  <h2 id="Other Options">Other Options</h2>
    ...
    <dt id="Retain Filters">Retain Filters</dt>
      <dd>
        <p>The Retain Filter checkbox under the search bar allows you to keep the same filters selected while performing another search.</p>
      </dd>
  </dl>
