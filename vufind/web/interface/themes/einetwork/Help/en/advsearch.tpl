<div class="help-content">
    ...
    <dl class="Content help-content">
      <dt><a id="SearchFields" name="SearchFields"></a><span class="bold">Search Fields</span></dt>
      <dd>
      ...
      <dt><a id="SearchGroups" name="SearchGroups"></a><span class="bold">Search Groups</span></dt>
      <dd>
