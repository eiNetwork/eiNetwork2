<div class="help-content">
    ...
    <ul class="HelpMenu">
        ...
        <li><a class="help" href="#FuzzySearches">Fuzzy Searches</a></li>
        <li><a class="help" href="#ProximitySearches">Proximity Searches</a></li>
        <li><a class="help" href="#RangeSearches">Range Searches</a></li>
        <li><a class="help" href="#BoostingTerm">Boosting a Term</a></li>
        <li><a class="help" href="#BooleanOperators">Boolean Operators</a>
          <ul>
            <li><a class="help" href="#OR">OR</a></li>
            <li><a class="help" href="#AND">AND</a></li>
            <li><a class="help" href="#PLUS">+</a></li>
            <li><a class="help" href="#NOT">NOT</a></li>
            <li><a class="help" href="#MINUS">-</a></li>
          </ul>
        </li>
    </ul>

    <dl class="Content help-content">
    <dt><a id="PhraseSearches" name="Phrase Searches"></a><span class="bold">Phrase Searches ("")</span></dt>
    <dd>
    ...
    <dt><a id="WildcardSearches" name="WildcardSearches"></a><span class="bold">Wildcard Searches</span></dt>
    <dd>
    ...
    <dt><a id="FuzzySearches" name="FuzzySearches"></a><span class="bold">Fuzzy Searches</span></dt>
    <dd>
    ...
    <dt><a id="ProximitySearches" name="ProximitySearches"></a><span class="bold">Proximity Searches</span></dt>
    <dd>
      <p>
    ...
    {literal}
    <dt><a id="RangeSearches" name="RangeSearches"></a><span class="bold">Range Searches</span></dt>
    <dd>
      <p>
    ...
    <dt><a id="BoostingTerm" name="BoostingTerm"></a><span class="bold">Boosting a Term</span></dt>
    <dd>
      <p>
    ...
    <dt><a id="BooleanOperators" name="BooleanOperators"></a><span class="bold">Boolean Operators</span></dt>
    <dd>
      <p>
      ...
      <dl>
        <dt><a id="OR" name="OR"></a><span class="bold">OR</span></dt>
        <dd>
        ...
        <dt><a id="AND" name="AND"></a><span class="bold">AND</span></dt>
        <dd>
        ...
        <dt><a id="PLUS" name="PLUS"></a><span class="bold">+</span></dt>
        <dd>
        ...
        <dt><a id="NOT" name="NOT"></a><span class="bold">NOT</span></dt>
        <dd>
        ...
        <dt><a id="MINUS" name="MINUS"></a><span class="bold">-</span></dt>
        <dd>
