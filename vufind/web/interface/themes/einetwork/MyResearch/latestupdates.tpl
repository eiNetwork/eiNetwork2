...
<li><span class="bold">Enable ability for users to retain filters between searches.</span>
Provided ability to retain filters across multiple searches.  A checkbox under the search box supports this feature.</li>
<li><span class="bold">Improve searching from within the library.</span>
...
<li><span class="bold">Misc. bug fixes:</span>
<ol class="alpha">
