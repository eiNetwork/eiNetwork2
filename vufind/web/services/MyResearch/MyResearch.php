		...
		if ($user !== false){
			...
			if ($user){
				...
				if ($profile['fines'] != '$0.00'){
					$notifications['messages'][] = 'You have ' . $profile['fines'] . ' in overdue fines. <input type="button" class="button pay-fine-button" onclick="window.open(\'http://www.einetwork.net/forward.html\')" value="Pay Fine" title="Pay overdue fine on-line" />';
				}
