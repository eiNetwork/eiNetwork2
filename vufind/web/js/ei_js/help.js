$( document ).ready(function() {
	...
	$('.qtip-preferred-libraries').qtip({ // Grab some elements to apply the tooltip to
	    content: {
	        text: 'Specifying Preferred Libraries sets your default pickup location for items requested online.<a id="qtip-link-building" href="/Help/Home?topic=myaccount#Location">Read More...</a>'
	    },
	    hide: {
	        delay: 1000
	    },
